...
const MET: React.FC<METProps> = ({ telemetryData }) => {
    const { dataPoints, latestData, chartData, dataCount } = useDataAccumulator(telemetryData, {
        maxDataPoints: 60,
        shouldAdd: (data) => data.met !== undefined,
        extractData: (data) => data.met
    });
        ...
        <div className="bg-cyan-50 p-4 rounded-lg border border-cyan-200">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                <div className="bg-white p-3 rounded border">
                    ...
                    <p className="text-2xl font-bold text-cyan-600">{dataCount}</p>
                </div>
                <div className="bg-white p-3 rounded border">
            ...
            {latestData && (
                <div className="bg-white p-3 rounded border mb-4">
                    <p className="text-sm text-gray-600 mb-2">Latest MET Data:</p>
